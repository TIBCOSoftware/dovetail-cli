...
func resourcesKotlinContractTemplate() (*asset, error) {
	...
	info := bindataFileInfo{name: "resources/kotlin.contract.template", size: 1539, mode: os.FileMode(420), modTime: time.Unix(1563827395, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func resourcesKotlinContractimplTemplate() (*asset, error) {
	...
	info := bindataFileInfo{name: "resources/kotlin.contractimpl.template", size: 429, mode: os.FileMode(420), modTime: time.Unix(1564772303, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func resourcesKotlinStateTemplate() (*asset, error) {
	...
	info := bindataFileInfo{name: "resources/kotlin.state.template", size: 4935, mode: os.FileMode(420), modTime: time.Unix(1564685503, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
