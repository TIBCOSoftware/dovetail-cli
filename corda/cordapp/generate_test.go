...
func TestParser(t *testing.T) {
	...
	*/
	...
	opts := NewOptions("/Users/mwenyan@tibco.com/dovetail/src/github.com/TIBCOSoftware/dovetail-cli/corda/cordapp/iou.json", "2.0.0", wdir, "com.example.flows.iou", "", false)
